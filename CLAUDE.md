...
- Built on the official `ModelContextProtocol` C# SDK 2.1.0 + `ModelContextProtocol.AspNetCore` 2.1.0
...
# MCP initialise (server negotiates down to 2026-07-28, the revision it currently supports)
...
- **MCP SDK**: Using `ModelContextProtocol` 2.1.0 plus `ModelContextProtocol.AspNetCore` 2.1.0 for HTTP hosting.
