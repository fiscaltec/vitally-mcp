...
parity check is in `docs/runbooks/entra-app-registration.md` and is **manual** — #134 proposed automating it and was closed `not planned` (2026-09-21, Entra-only). Run it before a rollback; nothing else will.
