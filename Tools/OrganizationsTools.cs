...
{
    [McpServerTool, DisplayName("List organizations"), Description("List Vitally organisations with optional pagination and field selection")]
    ...
    [McpServerTool, DisplayName("Get organization"), Description("Get a single Vitally organisation by ID")]
