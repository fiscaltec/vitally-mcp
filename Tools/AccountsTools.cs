...
{
    [McpServerTool(Name = "List_account", Title = "List account", ReadOnly = true), Description("List Vitally accounts with optional pagination, filtering and field selection")]
    ...
    [McpServerTool(Name = "Get_account", Title = "Get account", ReadOnly = true), Description("Get a single Vitally account by ID")]
