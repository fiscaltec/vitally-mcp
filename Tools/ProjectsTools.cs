...
{
    [McpServerTool, DisplayName("List projects"), Description("List Vitally projects with optional pagination and field selection")]
    ...
    [McpServerTool, DisplayName("Get project"), Description("Get a single Vitally project by ID")]
