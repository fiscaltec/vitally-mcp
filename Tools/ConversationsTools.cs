...
public static class ConversationsTools
{
    ...
    public static async Task<string> ListConversations(
        ...
        [Description("Comma-separated list of fields to include (e.g., 'id,subject,status')")] string? fields = null)
    {
        return await vitallyService.GetResourcesAsync("conversations", limit, cursor, fields);
    }
